...
<template>
  <div>
    <div
      ...
      v-for="(project, index, key) of projectData"
      :key="key"
    >
        ...
        <section class="section-spacer">
          <div class="project-branding__wrapper">
            <div class="project-branding__color">
              <ul>
                <li
                  v-for="(projectColor, index, key) of project.colors"
                  :key="key"
                >
            ...
            <div class="project-branding__typography__wrapper">
              <div
                class="project-branding__typography"
                v-for="(projectFont, index, key) of project.fonts"
                :key="key"
              >
                <div
                  class="project-branding__typography-title"
                  :style="{ fontFamily: projectFont + ', sans-serif' }"
                >
                  {{ projectFont }}
                </div>
                <div
                  class="project-branding__typography-text"
                  :style="{ fontFamily: projectFont + ', sans-serif' }"
                >
                  <p :style="{ fontFamily: projectFont + ', sans-serif' }">
              ...
              >
                <div
                  class="project-branding__typography-text"
                  :style="{ fontFamily: projectFont + ', sans-serif' }"
                  v-if="project.fonts.length < 2"
                >
                  <p
                    :style="{
                      fontFamily: projectFont + ', sans-serif',
                      fontWeight: 400,
                    }"
                  >
                    ABCDEFGHIJKLMNOPQRSTUVWXYZ
                ...
                <div
                  v-if="project.fonts.lenght > 1"
                  class="project-branding__typography-text project-branding__typography-text--light"
                  :style="{
                    fontFamily: projectFont + ', sans-serif',
                    fontWeight: 300,
                  }"
